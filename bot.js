...
*/
                        ...
                        try {
                            ...
                            if (config.LANG == 'TR' || config.LANG == 'AZ') {
                                ...
                                await conn.sendMessage(conn.user.jid, '*-- ERROR REPORT [PrinceRudhV2] --*' + 
                                    '\n*PrinceRudhV2 an error has occurred!*'+
                                ...
                                if (error.message.includes('URL')) {
                                    return await conn.sendMessage(conn.user.jid, '*⚕️ ERROR ANALYSIS [PrinceRudhV2] ⚕️*' + 
                                        '\n========== ```Error Resolved!``` ==========' +
