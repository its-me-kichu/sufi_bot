...
if (conf.LANG == 'EN') vtalk_dsc = 'Starts to PrinceRudh voice chat.', reply_eva = '*Reply to Any Voice Message!*'
...
var succ_off = ''
if (conf.LANG == 'TR') {
    fulleva_dsc = 'Tam fonksiyonel PrinceRudh özelliklerini aktif eder. Hesabınızı bir chatbota dönüştürün!'
    already_on = 'PrinceRudh yapay zekası halihazırda tüm fonksiyonları etkin.'
    already_off = 'PrinceRudh yapay zekası halihazırda yarı fonksiyonel çalışıyor.'
    succ_on = 'PrinceRudh, Tam Fonksiyonel Olarak Açıldı! Lütfen Biraz Bekleyin! ✅'
    succ_off = 'PrinceRudh, Yarı Fonksiyonel Olarak Ayarlandı! Lütfen Biraz Bekleyin! ☑️'
}
if (conf.LANG == 'EN') {
    fulleva_dsc = 'Activates full functional PrinceRudh features. Turn your account into a ai chatbot!'
    already_on = 'PrinceRudh artificial intelligence is already fully functional.'
    already_off = 'PrinceRudh artificial intelligence is currently running semi-functional.'
    succ_on = 'PrinceRudh Opened Fully Functionally! Please wait a bit! ✅'
    succ_off = 'PrinceRudh Set to Semi-Functional! Please wait a bit! ☑️'
}
if (conf.LANG == 'ML') {
