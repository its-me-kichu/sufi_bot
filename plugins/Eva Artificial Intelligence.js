...
if (conf.LANG == 'EN') vtalk_dsc = 'Starts to PrinceRudhV2 voice chat.', reply_eva = '*Reply to Any Voice Message!*'
...
var succ_off = ''
if (conf.LANG == 'TR') {
    fulleva_dsc = 'Tam fonksiyonel PrinceRudhV2 özelliklerini aktif eder. Hesabınızı bir chatbota dönüştürün!'
    already_on = 'PrinceRudhV2 yapay zekası halihazırda tüm fonksiyonları etkin.'
    already_off = 'PrinceRudhV2 yapay zekası halihazırda yarı fonksiyonel çalışıyor.'
    succ_on = 'PrinceRudhV2, Tam Fonksiyonel Olarak Açıldı! Lütfen Biraz Bekleyin! ✅'
    succ_off = 'PrinceRudhV2, Yarı Fonksiyonel Olarak Ayarlandı! Lütfen Biraz Bekleyin! ☑️'
}
if (conf.LANG == 'EN') {
    fulleva_dsc = 'Activates full functional PrinceRudhV2 features. Turn your account into a ai chatbot!'
    already_on = 'PrinceRudhV2 artificial intelligence is already fully functional.'
    already_off = 'PrinceRudhV2 artificial intelligence is currently running semi-functional.'
    succ_on = 'PrinceRudhV2 Opened Fully Functionally! Please wait a bit! ✅'
    succ_off = 'PrinceRudhV2 Set to Semi-Functional! Please wait a bit! ☑️'
}
if (conf.LANG == 'ML') {
