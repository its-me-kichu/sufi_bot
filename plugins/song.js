...
r_text[1] = "Princettane tholpikkaan ningalkavilla. Jeevitathil Princettane tholpichittundu… palarum… palavattom…😥😥 aarellum aaa sed bgm onn iduo...";
r_text[2] = "Prince says i love you 😘";
r_text[3] = "Princettante yudhangal Company Kanan Povunnatheyuloo";
r_text[4] = "hi, how are you";
r_text[5] = "ennikk korch rest theroo...🥵🥵";
r_text[6] = "PrinceRudhV2  - Prince \ningane ethra ethra paerugal aan alle enikk..😂🤣";
...
r_text[8] = "\n enne vilicho...?🧐 \n";
r_text[9] = "ente per Princerudh,ninte per donkey, backi ellarum monkey😼😼";
r_text[10] = "nee vilicha enikk villi kelkathe irrikkaan pattuo";
r_text[11] = "do you know who is my creator..? its none other than Prince Rudh";
...
r_text[13] = ".song adich thangalude fav song name para Princerudh ath download aakki theraam";
...
r_text[18] = "enikk njan und Prince Rudh uyir";
...
r_text[22] = "Kaanaan oru look illanney ullu… bhayankara budhiya\n\n ninnak allatto enik Princerudh";
r_text[23] = "Ithalla ithinapparam chaadi kadannavananee  Princerudh";
...
r_text[31] = "My phone number is 9895339960"; 
